...
namespace UnityTemplateProjects
{
    ...
    public class SimpleCameraController : MonoBehaviour
    {
        class CameraState
        {
            ...
            {
                pitch = t.eulerAngles.x;//俯仰角
                yaw = t.eulerAngles.y;//偏航角
                roll = t.eulerAngles.z;//翻滚角
                x = t.position.x;
                y = t.position.y;
                z = t.position.z;
            }
        ...
        void Update()
        {
            ...
            if (IsCameraRotationAllowed())
            {
                ...
                //vector.length 计算得出鼠标偏移值的长度和曲线值得平均值
            ...
            //m_TargetCameraState中得数据是被修改之后得数据
            //m_InterpolatingCameraState中的数据是被修改之前的数据
            //m_InterpolatingCameraState.LerpTowards(m_TargetCameraState, positionLerpPct, rotationLerpPct);
            //这里传transform就完全是在里面修改，但没有用ref
            transform.eulerAngles=new Vector3(m_TargetCameraState.pitch,m_TargetCameraState.yaw,m_TargetCameraState.roll);
            transform.position=new Vector3(m_TargetCameraState.x,m_TargetCameraState.y,m_TargetCameraState.z);
        }
